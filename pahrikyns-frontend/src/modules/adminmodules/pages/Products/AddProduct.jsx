...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("ASSET INITIALIZED SUCCESSFULLY", "success");
      ...
      <Paper sx={{ p: 5, borderRadius: 8, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", backgroundImage: "none", boxShadow: "0 40px 100px rgba(0,0,0,0.4)" }}>
        <form onSubmit={handleSubmit}>
              ...
              <Stack spacing={4}>
                <Box>
                  <Typography variant="caption" sx={{ fontWeight: 800, color: "rgba(255,255,255,0.3)", mb: 2, display: "flex", alignItems: "center", gap: 1, letterSpacing: 1 }}>
                    <BookTwoToneIcon sx={{ fontSize: 14 }} /> KNOWLEDGE ASSET IDENTITY
                  </Typography>
                  <TextField fullWidth placeholder="ENTER ASSET TITLE..." value={form.title} onChange={handleChange("title")} sx={fieldStyle} required />
                </Box>
          ...
          <Stack direction="row" spacing={3} justifyContent="flex-end">
            <Button variant="outlined" onClick={() => navigate("/admin/products")} startIcon={<CancelTwoToneIcon />} sx={{ borderRadius: "12px", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)", fontWeight: 900, px: 4 }}>ABORT</Button>
